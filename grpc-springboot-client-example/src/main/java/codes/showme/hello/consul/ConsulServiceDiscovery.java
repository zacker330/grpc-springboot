...
public class ConsulServiceDiscovery implements ServiceDiscovery {
    ...
    private ConsulServiceDiscovery(String agentHost, int agentPort) {
        log.info("ConsulServiceDiscovery, agentHost:{}, agentPort:{}", agentHost, agentHost);
    ...
    public List<ServiceNode> getHealthServices(String serviceName) {
        ...
        for (HealthService healthService : healthServices) {
            ...
            int port = Integer.parseInt(healthService.getNode().getMeta().getOrDefault("grpc.port", "6565"));
